...
router.post("/user/insertCustomer", auth, UserController.InsertCustomer);
...
router.get("/employee/getAll", auth, EmployeeController.getAllSuper);
router.get("/employee/export", auth, EmployeeController.ExportEmployee);
...
router.get("/fix/getAllByWorkshop", auth, FixController.getAllFixFromWorkshop);
router.get("/fix/getAllByBooking", auth, FixController.getAllFixFromBooking);
router.get("/fix/getAllByBranchFromBooking/:branch_id", auth, FixController.getAllFixByBranchFromBooking);
